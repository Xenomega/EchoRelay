...
{
    /// <summary>
    /// A message from server to client indicating their <see cref="LoggedInUserProfileRequest"/> failed.
    /// </summary>
    public class LoggedInUserProfileFailure : Message
    {
        #region Fields
        /// <summary>
        /// The unique 64-bit symbol denoting the type of message.
        /// </summary>
        public override long MessageTypeSymbol => -332370982458323871;
        ...
        /// </summary>
        public LoggedInUserProfileFailure()
        {
        ...
        public LoggedInUserProfileFailure(XPlatformId userId, HttpStatusCode statusCode, string message)
        {
            UserId = userId;
