...
{
    /// <summary>
    /// A message from server to client indicating their <see cref="LoginRequest"/> succeeded, providing them a new session token.
    /// </summary>
    public class LoginSuccess : Message
    {
        ...
        /// </summary>
        public override long MessageTypeSymbol => -6508614429644632505;
        ...
        /// <summary>
        /// Initializes a new <see cref="LoginSuccess"/> message with the provided arguments.
        /// </summary>
        ...
        public LoginSuccess(XPlatformId userId, Guid session)
        {
            UserId = userId;
            Session = session;
        }
