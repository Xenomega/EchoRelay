...
{
    /// <summary>
    /// A message from server to client indicating their <see cref="OtherUserProfileRequest"/> failed.
    /// </summary>
    public class OtherUserProfileFailure : Message
    {
        #region Fields
        /// <summary>
        /// The unique 64-bit symbol denoting the type of message.
        /// </summary>
        public override long MessageTypeSymbol => 1307472398732561827;
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new <see cref="OtherUserProfileFailure"/> message.
        /// </summary>
        public OtherUserProfileFailure()
        {
        ...
        /// <summary>
        /// Initializes a new <see cref="OtherUserProfileFailure"/> message with the provided arguments.
        /// </summary>
        ...
        public OtherUserProfileFailure(XPlatformId userId, HttpStatusCode statusCode, string message)
        {
            UserId = userId;
