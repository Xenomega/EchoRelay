...
namespace EchoRelay.Core.Server.Messages.Matching
{
    ...
    /// </summary>
    public class LobbySessionFailurev4 : Message
    {
        #region Fields
        /// <summary>
        /// The unique 64-bit symbol denoting the type of message.
        /// </summary>
        public override long MessageTypeSymbol => 5397623933917067628;
        ...
        /// <summary>
        /// The message sent with the failure.
        /// </summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new <see cref="LobbySessionFailurev4"/> message.
        /// </summary>
        public LobbySessionFailurev4()
        {
            ChannelUUID = new Guid();
            Message = "";
        }
        /// <summary>
        /// Initializes a new <see cref="LobbySessionFailurev4"/> with the provided arguments.
        /// </summary>
        ...
        /// <param name="message">The error message to send with the failure.</param>
        public LobbySessionFailurev4(long gameTypeSymbol, Guid channel, LobbySessionFailureErrorCode errorCode, uint unk0, string message)
        {
