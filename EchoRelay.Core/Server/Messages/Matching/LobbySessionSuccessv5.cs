...
namespace EchoRelay.Core.Server.Messages.Matching
{
    ...
    /// session succeeded.
    /// </summary>
    public class LobbySessionSuccessv5 : Message
    {
        #region Fields
        /// <summary>
        /// The unique 64-bit symbol denoting the type of message.
        /// </summary>
        public override long MessageTypeSymbol => 7876201346521829647;
        ...
        public LobbySessionSuccessv5(long gameTypeSymbol, Guid matchingSession, Guid channelUUID, LobbyPingRequestv3.EndpointData endpoint, short teamIndex, uint unk1, ulong serverEncoderFlags, ulong clientEncoderFlags, ulong serverSequenceId, byte[] serverMacKey, byte[] serverEncKey, byte[] serverRandomKey, ulong clientSequenceId, byte[] clientMacKey, byte[] clientEncKey, byte[] clientRandomKey)
        {
