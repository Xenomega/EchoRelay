...
{
    /// <summary>
    /// A message from game server to server, indicating player sessions have been unlocked on the game server.
    /// NOTE: This is an unofficial message created for Echo Relay.
    /// </summary>
    public class ERGameServerPlayerSessionsUnlocked : Message
    {
        #region Fields
        /// <summary>
        /// The unique 64-bit symbol denoting the type of message.
        /// </summary>
        public override long MessageTypeSymbol => 0x7777777777770400;
